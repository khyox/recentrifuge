...
Recentrifuge is especially useful in the case of **low microbial biomass** metagenomic studies and when a more reliable detection of minority organisms is needed, like in clinical, environmental and forensic analysis.
...
""",
    ...
    scripts=['rcf', 'rextract', 'retaxdump', 'remock'],
