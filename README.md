...
Recentrifuge enables researchers to analyze results from the Centrifuge, LMAT and CLARK classifiers using interactive pie charts, by placing great emphasis on the confidence level (score) of the taxonomic classifications.
