...
"""
import sys
from typing import Set, Counter, Iterable, Tuple, Optional, Union
...
class GeneOntology(Ontology):
    ...
    def __init__(self,
        ...
        if excluding:
            ...
            for goid in excluding:
                print(f'\t\t{goid}\t{self.names[goid]}')
        self.excluding: Union[Tuple[()], Set[Id]] = excluding if excluding else ()
    ...
    def read_nodes(self, nodes_file: Filename) -> None:
        ...
        sys.stdout.flush()
        line: str = ''  # Initialize for potential ValueError reporting
        try:
    ...
    def get_rank(self, anid: Id) -> Rank:
        ...
        return self.ranks.get(anid, Rank.NO_RANK)
